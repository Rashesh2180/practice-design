    ...
    <div className=" py-[120px]">
      <div className=" max-w-[1322px] mx-auto px-4 flex items-center gap-10 lg:gap-5 max-lg:flex-col xl:gap-[90px]">
        <div className="flex-1 ">
          <div className="flex gap-[25px] items-start pl-[19px]">
            <div className=" max-w-[312px] z-10  w-full h-[365px] rounded-[20px] overflow-hidden">
              <img
            ...
            <div className=" max-w-[244px] w-full mt-[45px] h-[217px] rounded-[20px] overflow-hidden">
              <img
          ...
          <div className="flex gap-[19px] items-start -mt-3">
            <div className=" max-w-[307.97px] relative w-full h-[267px] rounded-[20px] overflow-hidden">
              ...
              <div className="  rounded-[20px] bg-primary py-10 pr-8 pl-[38px] absolute top-9 left-[46px]">
                ...
                <div className=" mt-[10px]  max-w-[104px] mx-auto text-base text-white leading-[30px]">
                  years of experiences
                </div>
              </div>
            </div>
            <div className=" max-w-[312px] w-full relative  -mt-[64px] -ml-[88px] h-[312px]  rounded-[20px] overflow-hidden">
              <img
